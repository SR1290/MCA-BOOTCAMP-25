...
/** Q15
    ...
    // Program to display heat status based on flag value

// Prompt user for input
let flag = parseInt(prompt("Enter Heat code (1-3):"), 10);

// Variable to store the heat status
let status;

// Switch statement to determine the heat status
switch (flag) {
    case 1:
        status = "HOT";
        break;
